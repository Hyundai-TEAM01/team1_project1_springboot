...
public class ThymeleafController {
	...
	public String linkUrlExpressions(@RequestParam(defaultValue = "") String productId,
			@RequestParam(defaultValue = "0") int pageNo, @PathVariable String typeId, Model model) {
		log.info("실행");
