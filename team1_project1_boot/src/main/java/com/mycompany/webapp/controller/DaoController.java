...
public class DaoController {
	...
	public String boardWrite(Board board) throws Exception {
		...
		if (board.getBattach() != null && !board.getBattach().isEmpty()) {
			...
			File file = new File("D://Temp//" + board.getBattachsname());
			mf.transferTo(file);
		}
		boardService.writeBoard(board);
	...
	public void battachDownload(HttpServletResponse response, int bno) throws Exception {
		...
		String battachspath = "D://Temp//" + battachsname;
